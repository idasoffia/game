...
use function Mos\Dice\Dice;
use function Mos\Dice\DiceHand;
use function Mos\Dice\GraphicalDice;
...
<form action="<?= url("/play21/set-hand")?>" method="post" class="numberOfDice">
    <div>
